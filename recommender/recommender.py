...
from dataProcessing import read_user_likes_raw_data, read_all_restaurant, preprocess_data
from sklearn.preprocessing import normalize


def recommend(user_likes, all_data):
...
user = read_user_likes_raw_data('random_admin')
all_restaurants = read_all_restaurant()
preprocessed_restaurant = preprocess_data(all_restaurants)
recommend(user, preprocessed_restaurant)
